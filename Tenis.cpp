...
const std::string NOM_FICHERO = "tenistas.txt";
...
void inicializarJugador(tjugador& jugador) { //Inicializa las caracter sticas del jugador indicado
	jugador.siglas = "";
	jugador.habilidad = 0;
	jugador.velocidad = 0;
...
void escribeEstadisticas(tjugador aTenistas[], int indic) { //Escribe las estad sticas del juego al final de cada juego
...
void jugarPartido(tListaJug& listaJug) { //Controla el juego de los partidos
	...
	while (jug0 == listaJug.cont) {
		std::cout << "No existe ning n tenista con esas iniciales\n";
